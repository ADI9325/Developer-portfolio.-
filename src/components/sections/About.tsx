  ...
  return (
    <section id="about" className="py-24 px-6">
      <div className="mx-auto max-w-6xl">
        {/* Section label */}
        <p className="mb-3 text-center font-mono text-sm text-indigo-400">01. about me</p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              {/* Decorative ring */}
              <div className="absolute -inset-4 rounded-2xl bg-gradient-to-br from-indigo-500/30 to-violet-500/20 blur-xl" />
              <div className="relative h-64 w-64 overflow-hidden rounded-2xl border-2 border-indigo-500/40 bg-slate-800 sm:h-80 sm:w-80">
                {/* Placeholder avatar */}
                <div className="flex h-full w-full flex-col items-center justify-center gap-3 bg-gradient-to-br from-slate-800 to-slate-700">
                  ...
                  <span className="text-sm text-slate-400">Aditya</span>
                </div>
              </div>
              {/* Floating badge */}
              <div className="absolute -bottom-4 -right-4 rounded-xl border border-slate-700 bg-slate-800 px-4 py-2 text-sm font-semibold text-slate-200 shadow-xl">
                2+ yrs exp
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {chips.map(({ icon: Icon, text }) => (
                <span
                  key={text}
                  className="inline-flex items-center gap-2 rounded-full border border-slate-700 bg-slate-800 px-4 py-2 text-sm text-slate-300"
                >
